...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Static source code analysis tool using regular expression signatures.}
  spec.description   = %q{Static source code analysis tool using regular expression signatures.}
